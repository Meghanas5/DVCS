// ======================================================================
// CE210289_CapSense_P4_Linear_Slider01.v generated from TopDesign.cysch
// 04/03/2017 at 15:58
...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=120, Polarity=1, Resolution=7, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CapSense:IDACComp, CY_INSTANCE_SHORT_NAME=IDACComp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=CapSense_IDACComp, )
...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=120, Polarity=1, Resolution=8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CapSense:IDACMod, CY_INSTANCE_SHORT_NAME=IDACMod, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=CapSense_IDACMod, )
...
module top ;
    ...
    CapSense_P4_v3_10_2 CapSense ();

    SCB_P4_v3_20_3 EZI2C (
        .cts_in(1'b0),
        .tx_out(Net_33),
        .rts_out(Net_34),
        .interrupt(Net_35),
