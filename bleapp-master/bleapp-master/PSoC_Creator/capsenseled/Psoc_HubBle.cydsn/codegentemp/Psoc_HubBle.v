// ======================================================================
// Psoc_HubBle.v generated from TopDesign.cysch
// 04/26/2017 at 03:20
...
module BLE_v3_30_0 (
	...
	cy_clock_v1_0
		#(.id("26970c30-e157-4756-b113-418f41737050/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	wire [0:0] tmpOE__LED_Conn_net;
	wire [0:0] tmpFB_0__LED_Conn_net;
	wire [0:0] tmpIO_0__LED_Conn_net;
	wire [0:0] tmpINTERRUPT_0__LED_Conn_net;
	electrical [0:0] tmpSIOVREF__LED_Conn_net;

	cy_psoc3_pins_v1_10
		#(.id("092067a7-b781-42a9-9041-c6c410bf643b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_Conn
		 (.oe(tmpOE__LED_Conn_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_Conn_net[0:0]}),
		  .io({tmpIO_0__LED_Conn_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_Conn_net),
		  .interrupt({tmpINTERRUPT_0__LED_Conn_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_Conn_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
