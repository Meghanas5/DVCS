...
#define CYBLE_CUSTOMC_VENTSERVICE_SERVICE_INDEX   (0x00u) /* Index of VentService service in the cyBle_customCServ array */
#define CYBLE_CUSTOMC_VENTSERVICE_CUSTOM_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of Custom Characteristic characteristic */
#define CYBLE_CUSTOMC_VENTSERVICE_CUSTOM_CHARACTERISTIC_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
