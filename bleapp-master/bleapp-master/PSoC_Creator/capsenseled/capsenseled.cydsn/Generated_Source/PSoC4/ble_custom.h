...
#define CYBLE_LEDCAPSENSE_TEMP_CHAR_INDEX   (0x01u) /* Index of Temp characteristic */
#define CYBLE_LEDCAPSENSE_TEMP_TEMPCCCD_DESC_INDEX   (0x00u) /* Index of Tempcccd descriptor */
...
#define CYBLE_LEDCAPSENSE_TEMP_DECL_HANDLE   (0x0010u) /* Handle of Temp characteristic declaration */
#define CYBLE_LEDCAPSENSE_TEMP_CHAR_HANDLE   (0x0011u) /* Handle of Temp characteristic */
#define CYBLE_LEDCAPSENSE_TEMP_TEMPCCCD_DESC_HANDLE   (0x0012u) /* Handle of Tempcccd descriptor */
#define CYBLE_LEDCAPSENSE_TEMP_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */
