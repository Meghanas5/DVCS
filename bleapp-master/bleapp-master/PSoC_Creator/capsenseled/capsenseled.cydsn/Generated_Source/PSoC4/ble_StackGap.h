...
/* Accept only advertisement packets from devices where the advertiser뭩 address
...
/* Accept all advertisement packets from devices where the advertiser뭩 address
...
* peer Public and Random (static) Identity Address. The peer뭩 resolvable address being used may 
...
* Identity Address. The local뭩 resolvable address being used may change after the command is called.
*
*  \param peerIdentityAddr: Buffer which contains the information of peer bd address and address type
