...
const uint8 cyBle_attUuid128[][16u] = {
    /* VentService */
    { 0xE7u, 0x67u, 0xDAu, 0xECu, 0xC3u, 0x57u, 0x01u, 0x8Du, 0xB8u, 0x4Du, 0x65u, 0xD1u, 0x12u, 0xBAu, 0xA2u, 0x27u },
    /* led */
    { 0x9Bu, 0xC3u, 0xFDu, 0x81u, 0x12u, 0xB1u, 0x5Fu, 0x9Fu, 0xC1u, 0x49u, 0x01u, 0x3Du, 0xC8u, 0xF4u, 0x9Bu, 0x44u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0001u, (void *)&cyBle_attValues[24] }, /* led */
    { 0x0009u, (void *)&cyBle_attValues[25] }, /* Characteristic User Description */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x13u] = {
    ...
    { 0x0012u, 0xF4C8u /* led                                 */, 0x090A0101u /* rd,wr */, 0x0013u, {{0x0001u, (void *)&cyBle_attValuesLen[9]}} },
