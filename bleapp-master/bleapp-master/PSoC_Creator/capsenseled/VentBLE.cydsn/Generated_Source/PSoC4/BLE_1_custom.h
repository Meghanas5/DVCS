...
#define CYBLE_VENTSERVICE_LED_CHAR_INDEX   (0x00u) /* Index of led characteristic */
#define CYBLE_VENTSERVICE_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CYBLE_VENTSERVICE_SERVICE_HANDLE   (0x0010u) /* Handle of VentService service */
#define CYBLE_VENTSERVICE_LED_DECL_HANDLE   (0x0011u) /* Handle of led characteristic declaration */
#define CYBLE_VENTSERVICE_LED_CHAR_HANDLE   (0x0012u) /* Handle of led characteristic */
#define CYBLE_VENTSERVICE_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */
