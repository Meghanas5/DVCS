// ======================================================================
// Proc_VentBLE.v generated from TopDesign.cysch
// 04/26/2017 at 17:14
...
module BLE_v3_30_3 (
	...
	cy_clock_v1_0
		#(.id("f4af41e5-9ed2-4904-867b-785428bd6861/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	wire [0:0] tmpOE__LED_Scan_net;
	wire [0:0] tmpFB_0__LED_Scan_net;
	wire [0:0] tmpIO_0__LED_Scan_net;
	wire [0:0] tmpINTERRUPT_0__LED_Scan_net;
	electrical [0:0] tmpSIOVREF__LED_Scan_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_Scan
		 (.oe(tmpOE__LED_Scan_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_Scan_net[0:0]}),
		  .io({tmpIO_0__LED_Scan_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_Scan_net),
		  .interrupt({tmpINTERRUPT_0__LED_Scan_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_Scan_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__LED_Conf_net;
	wire [0:0] tmpFB_0__LED_Conf_net;
	wire [0:0] tmpIO_0__LED_Conf_net;
	wire [0:0] tmpINTERRUPT_0__LED_Conf_net;
	electrical [0:0] tmpSIOVREF__LED_Conf_net;

	cy_psoc3_pins_v1_10
		#(.id("b6dc73ca-d16f-46e2-8b45-eb881540302b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_Conf
		 (.oe(tmpOE__LED_Conf_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_Conf_net[0:0]}),
		  .io({tmpIO_0__LED_Conf_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_Conf_net),
		  .interrupt({tmpINTERRUPT_0__LED_Conf_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_Conf_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_4 PWM_Servo (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("6875b57a-ea55-4342-ab6f-de1afbd1f09c"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("73d4c0eb-3188-4db1-a032-f9c04d84a3ab"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
